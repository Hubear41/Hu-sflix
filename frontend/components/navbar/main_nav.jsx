...
class MainNav extends React.Component {
  ...
  handleSearchClick() {
    ...
    root.addEventListener("click", e => {
      if (
        this._isMounted &&
        this.state.search === "" &&
        e.target !== this.searchBar.current &&
        e.target !== this.searchField.current
      ) {
  ...
  render() {
    ...
    const tvBold = pathname === "/browse/tvshows" ? "current-nav" : "";
    const movieBold = pathname === "/browse/movies" ? "current-nav" : "";
    ...
    return (
      <header className="main-nav-bar-wrapper">
        <header
          className={`main-nav-bar ${navAnimation}`}
          ref={this.navbar}
        ...
        >
          ...
          <section className="right-nav">
            <form
              className={`search-bar-form ${searchAnimation}`}
              ref={this.searchBar}
